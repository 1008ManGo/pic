...
CREATE TABLE channels (
    ...
    max_tps INT DEFAULT 100 COMMENT '最大TPS',
    max_connections INT DEFAULT 3 COMMENT '最大连接数',
    heartbeat_interval INT DEFAULT 30 COMMENT '心跳间隔(秒)',
    reconnect TINYINT DEFAULT 1 COMMENT '断线重连 1开 0关',
    bind_type ENUM('tx','rz','trx') DEFAULT 'trx' COMMENT '绑定类型',
...
CREATE TABLE sms_records (
    ...
    country_code CHAR(2) NOT NULL COMMENT '国家代码',
    sender_id VARCHAR(21) COMMENT '发送者ID',
...
CREATE TABLE countries (
    ...
    code_phone VARCHAR(8) NOT NULL COMMENT '国际区号'
) COMMENT '国家代码表';
```
...
```sql
-- 插入国家数据
INSERT INTO countries (code, name, code_phone) VALUES
('CN', '中国', '86'),
('US', '美国', '1'),
('HK', '香港', '852'),
('TW', '台湾', '886'),
...
|---|----------|------|------|----------|----------|
| 1 | `/api/user/login` | POST | 用户登录 | username, password | token, user_info |
...
| # | 接口路径 | 方法 | 说明 | 请求参数 | 返回数据 |
|---|----------|------|------|----------|----------|
| 1 | `/api/admin/login` | POST | 管理员登录 | username, password | token |
